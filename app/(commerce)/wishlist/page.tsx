  ...
  return (
    <div className="container-page py-10 md:py-14">
      <div className="mb-8 flex items-center gap-3">
        ...
        <h1 className="font-display text-3xl font-semibold tracking-tight md:text-4xl">Your wishlist</h1>
      ...
      {products.length === 0 ? (
        <div className="flex flex-col items-center justify-center gap-4 rounded-lg border border-border bg-bg-secondary py-20 text-center">
          <div className="grid h-16 w-16 place-items-center rounded-full bg-surface"><Heart className="h-7 w-7 text-text-muted" /></div>
          <div>
            <p className="font-sub text-lg font-semibold">Nothing saved yet</p>
            <p className="mt-1 text-text-secondary">Double-tap anything you love — it lands here.</p>
          </div>
